...
// Drag-and-drop temporarily disabled — react-big-calendar's DnD addon has
// CJS/ESM interop issues with Vite production builds. Will be re-added
// with a custom implementation in a later phase.
